...
CREATE INDEX "EISTRONG"."IDX_LSHC_BUILD_INFO"
  ON "EISTRONG"."LSHC_BUILD_INFO" ("MAP_CODE" ASC, "ID" ASC);
...
CREATE INDEX "EISTRONG"."IDX_LSHC_ENT_INFO"
  ON "EISTRONG"."LSHC_ENT_INFO" ("HC_ID" ASC, "ID" ASC);
...
CREATE INDEX "EISTRONG"."IDX_LSHC_FILE"
  ON "EISTRONG"."LSHC_FILE" ("ID" ASC, "RIGHT_NO" ASC, "HC_ID" ASC);
...
CREATE INDEX "EISTRONG"."IDX_LSHC_INDEX_NOTICE"
  ON "EISTRONG"."LSHC_INDEX_NOTICE" ("NOTICE_TITLE" ASC, "ID" ASC);
